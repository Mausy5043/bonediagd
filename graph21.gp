...
plot "/tmp/sql21.csv"  using ($2+utc_offset):4 title "TMP36 [degC]"      with points pt 5 ps 0.2\
    ,"/tmp/sql21b.csv" using ($2+utc_offset):3 title "Room temperature [degC]" with points pt 5 ps 0.15\
    ,"/tmp/sql22.csv"  using ($2+utc_offset):4 title "DHT22 [degC]"      with points pt 5 ps 0.1\
